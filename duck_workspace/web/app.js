...
function renderDetail(){
  ...
  $("evidence-label").textContent=`${primary.passed}/${primary.total} visible development cases · ${primary.engine}`;
  ...
  $("gap-heading").textContent=primary.schema==="microduck.dynamic-laser-evaluation/v1"?"Mean visible gap":"Final gap";
