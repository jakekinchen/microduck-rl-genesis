"""V56 selected recipe FINAL on unchanged endurance gates."""
import argparse
import gzip
...
SUITE=ROOT/"experiments/walking/posture-development-v56.json"
FREEZE=ROOT/"experiments/walking/posture-endurance-freeze-v56.json"
...
def main():
    ...
    p.add_argument("--bank",choices=("diagnostic","fresh"))
    p.add_argument("--output",type=Path)
    p.add_argument("--video",action="store_true")
    p.add_argument("--recipe",choices=("control","face2","parent"))
    a=p.parse_args()
    ...
    if a.recipe == "parent" and a.bank != "fresh": p.error("parent only on new starts")
    ...
    try:
        ...
        result={"schema":"microduck.terrain-endurance-result/v1","bank":a.bank,"controller_variant":"V30-with-native-posture-v56","proof_class":"visible_development",
