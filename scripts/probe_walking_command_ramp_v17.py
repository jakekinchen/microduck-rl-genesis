...
FREEZE=ROOT/"experiments/walking/ramp-diagnostic-freeze-v17.json"
...
def main():
    ...
    sources.update({n:digest(ROOT/n) for n in ["scripts/probe_walking_command_ramp_v17.py",
        "experiments/walking/command_ramp.py","experiments/walking/command_ramp_v17.py","tests/test_command_ramp.py",
        "experiments/walking/COMMAND-RAMP-DIAGNOSTIC-v17.md"]})
    ...
    from experiments.walking.command_ramp_v17 import GentleYawStandingSwitchWorld as RampedStandingSwitchWorld
                        ...
                        try:
                            for i in range(900):
                                ...
                                if i%2==0:
                                    ...
                                    draw.text((10,8),f"V17 GENTLE YAW | {row['actor_mode']} | {name} | {row['session_time_s']:.2f}s",fill="white")
