...
def main():
    ...
    env = MicroduckGroundAlignedWalkingEnv(1, demo=True)
    ...
    report = {"schema": "microduck.cross-engine-fixed-action-diagnostic/v1",
        ...
        "physics": {"floor_masks": [1, 1], "voltage_v": 7.35, "drop_ohm": 0., "motor_ticks": ticks, "startup_history": "HOME in both engines"},
    ...
    for name in ("scripts/audit_walking_cross_engine_replay.py", "microduck/walking_ground_env.py", "microduck/walking_posture_env.py", "microduck/walking_controlled_env.py", "microduck/walking_env.py", "microduck/velocity_env.py", "microduck/bam_actuator.py", "microduck/constants.py", "experiments/walking/world.py", "evaluator/core.py"):
