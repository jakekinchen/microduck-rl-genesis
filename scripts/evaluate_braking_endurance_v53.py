...
FREEZE=ROOT/"experiments/walking/braking-endurance-freeze-v53.json"
...
def main():
    ...
    try:
        ...
        result={"schema":"microduck.terrain-endurance-result/v1","bank":a.bank,"controller_variant":"V53-transient-braking-on-V50-V15","proof_class":"visible_development",
