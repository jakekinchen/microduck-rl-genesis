"""V55 selected recipe FINAL on unchanged surfaces gates."""
import argparse
import gzip
...
FREEZE=ROOT/"experiments/walking/yaw-surfaces-freeze-v55.json"
...
from scripts.train_yaw_v55 import EXTRA
...
def main():
    ...
    p.add_argument("--recipe",choices=("control","yaw6"))
    a=p.parse_args()
    ...
    from experiments.walking.yaw_v55 import candidate
    ...
    try:
                            ...
                            try:
                                for i in range(round(window["duration_s"]*50)):
                                    ...
                                    if writer and i%2==0:
                                        ...
                                        draw.text((8,8),f'V55 {a.recipe} | {name} | {row["session_time_s"]:.2f}s | {role}',fill="white")
        ...
        result={"schema":"microduck.terrain-endurance-result/v1","bank":a.bank,"controller_variant":"V30-with-native-yaw-v55","candidate":a.recipe,"proof_class":"visible_development",
