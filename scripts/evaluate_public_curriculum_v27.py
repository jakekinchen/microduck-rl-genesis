"""V27 comparison on the unchanged exposed V25 surface bank."""
import argparse
...
FREEZE=ROOT/"experiments/walking/public-curriculum-freeze-v27.json"
from scripts.evaluate_walking_public_surfaces import SOURCES as V25_SOURCES
SOURCES=list(dict.fromkeys(V25_SOURCES+[
 "scripts/train_public_curriculum_v27.py", "scripts/evaluate_public_curriculum_v27.py",
 "microduck/public_surface_curriculum_v27.py", "experiments/walking/CONSERVATIVE-CURRICULUM-v27.md",
 "tests/test_public_surface_curriculum_v27.py"
]))
...
def main():
    ...
    p.add_argument("--candidate",choices=("walking","paired"),default="walking")
    a=p.parse_args()
    ...
    if a.freeze:
        with FREEZE.open("x") as f:
            json.dump({"schema":"microduck.terrain-endurance-freeze/v1",
                       ...
                       "parent_walking_checkpoint_sha256":WALK_SHA,"parent_standing_checkpoint_sha256":STAND_SHA,
    ...
    walking_run="walking-20260906-v27"
                            ...
                            try:
                                for i in range(round(window["duration_s"]*50)):
                                    ...
                                    if writer and i%2==0:
                                        ...
                                        draw.text((8,8),f'V27 | {name} | {row["session_time_s"]:.2f}s | {role}',fill="white")
