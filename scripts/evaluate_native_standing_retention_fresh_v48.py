"""V48 standing FINAL with V30 controller on exposed endurance gates."""
import argparse
import gzip
...
FREEZE=ROOT/"experiments/walking/native-standing-retention-fresh-freeze-v48.json"
...
SOURCES=list(dict.fromkeys(SOURCES+EXTRA+["scripts/evaluate_native_standing_retention_fresh_v48.py"]))
...
def main():
    ...
    try:
        ...
        result={"schema":"microduck.terrain-endurance-result/v1","bank":a.bank,"controller_variant":"V30-with-native-standing-retention-v48","proof_class":"visible_development",
