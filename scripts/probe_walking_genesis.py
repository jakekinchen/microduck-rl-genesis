...
def main():
    ...
    if training["status"] != "completed" or training["variant"] != "walking-v3":
        raise ValueError("completed walking-v3 final export required")
    ...
    env = MicroduckPostureWalkingEnv(1, demo=True)
    ...
    result = {"schema": "microduck.walking-genesis-diagnostic/v1", "cases": reports,
        ...
        "physics": {"engine": "Genesis CPU", "floor_masks": [65535, 65535], "voltage_v": 7.35, "drop_ohm": 0.},
    ...
    for name in list(training["source_sha256"])+["scripts/probe_walking_genesis.py", "experiments/walking/posture.py", "experiments/walking/suite-v1.json", "evaluator/core.py"]:
