...
FREEZE=ROOT/"experiments/walking/native-retention-fresh-freeze-v46.json"
...
SOURCES=list(dict.fromkeys(SOURCES+EXTRA+["scripts/evaluate_native_retention_fresh_v46.py"]))
...
def main():
    ...
    try:
        ...
        result={"schema":"microduck.terrain-endurance-result/v1","bank":a.bank,"controller_variant":"V30-with-native-retention-v46","proof_class":"visible_development",
