...
test -s "$INPUT_ROOT/run_m5_cuda_pilot_7.sh"
cp "$INPUT_ROOT/run_m5_cuda_pilot_7.sh" "$RECEIPT_ROOT/run_m5_cuda_pilot_7.sh"
sha256sum "$RECEIPT_ROOT/run_m5_cuda_pilot_7.sh" > "$RECEIPT_ROOT/harness-sha256.txt"
