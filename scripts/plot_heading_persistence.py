"""Plot recorded V23/V24 heading error without altering either evaluator."""
import json
...
def main():
    a=load('20260906-v23-endurance');b=load('20260906-v24-heading-persistence')
    ...
    for i,(key,ax) in enumerate(zip(a,axes)):
        ...
        ax.plot(*b[key],label='V24: reference persists through STOP',color='#187f82',linewidth=1.5)
    ...
    out=ROOT/'receipts/walking/20260906-v25-verification/heading-persistence.png'
