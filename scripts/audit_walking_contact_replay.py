...
def main():
    ...
    from microduck.walking_contact_env import MicroduckContactAlignedWalkingEnv
    ...
    env = MicroduckContactAlignedWalkingEnv(1, demo=True)
    ...
    for name in ("scripts/audit_walking_contact_replay.py", "microduck/walking_ground_env.py", "microduck/walking_contact_env.py", "microduck/walking_tracking_env.py", "microduck/walking_posture_env.py", "microduck/walking_controlled_env.py", "microduck/walking_env.py", "microduck/velocity_env.py", "microduck/bam_actuator.py", "microduck/constants.py", "experiments/walking/world.py", "evaluator/core.py"):
