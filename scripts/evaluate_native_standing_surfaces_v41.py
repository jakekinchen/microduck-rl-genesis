"""V41 native standing FINAL with V30 controller on exposed surfaces gates."""
import argparse
import gzip
...
FREEZE=ROOT/"experiments/walking/native-standing-surfaces-freeze-v41.json"
...
SOURCES = list(dict.fromkeys(SOURCES + ["scripts/evaluate_native_standing_surfaces_v41.py", "scripts/train_native_standing_v41.py", "microduck/native_standing_env_v41.py", "experiments/walking/NATIVE-STANDING-v41.md", "experiments/walking/native_candidate_v41.py"]))
...
def main():
    ...
    from experiments.walking.native_candidate_v41 import candidate_sha
    ...
    standing_run="standing-native-20260906-v41"
    ...
    try:
                            ...
                            try:
                                for i in range(round(window["duration_s"]*50)):
                                    ...
                                    if writer and i%2==0:
                                        ...
                                        draw.text((8,8),f'V41 | {name} | {row["session_time_s"]:.2f}s | {role}',fill="white")
        ...
        result={"schema":"microduck.terrain-endurance-result/v1","bank":a.bank,"controller_variant":"V30-with-native-standing-v41","candidate":a.candidate,"proof_class":"visible_development",
