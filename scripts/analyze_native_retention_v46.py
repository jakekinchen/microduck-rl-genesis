...
def main():
    ...
    for suffix,baseline,filename in pairs:
        candidate=ROOT/f'receipts/walking/20260907-v46-retention-{suffix}'
    ...
    trace_data={}
    for label,folder in [('V30 retained','20260906-v30-flat-regression'),('V46 candidate','20260907-v46-retention-flat')]:
    ...
    for label,color in [('V30 retained','#1d796a'),('V46 candidate','#bc4932')]:
    ...
    summary.update(candidate_rejected=not prerequisites,fresh_sequence_bank_opened=False,physical_calibration=False,
        ...
        interpretation='Same first knee-failure case after the V45 diagnosis; V46 uses original V15 standing. The original gates and all failed cases remain authoritative.')
