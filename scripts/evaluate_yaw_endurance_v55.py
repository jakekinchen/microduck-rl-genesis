"""V55 selected recipe FINAL on unchanged endurance gates."""
import argparse
import gzip
...
SUITE=ROOT/"experiments/walking/yaw-development-v55.json"
FREEZE=ROOT/"experiments/walking/yaw-endurance-freeze-v55.json"
...
def main():
    ...
    p.add_argument("--recipe",choices=("control","yaw6","parent"))
    a=p.parse_args()
    ...
    try:
        ...
        result={"schema":"microduck.terrain-endurance-result/v1","bank":a.bank,"controller_variant":"V30-with-native-yaw-v55","proof_class":"visible_development",
