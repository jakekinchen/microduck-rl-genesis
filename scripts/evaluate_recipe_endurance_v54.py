"""V54 selected recipe FINAL on unchanged endurance gates."""
import argparse
import gzip
...
FREEZE=ROOT/"experiments/walking/recipe-endurance-freeze-v54.json"
...
def main():
    ...
    try:
        ...
        result={"schema":"microduck.terrain-endurance-result/v1","bank":a.bank,"controller_variant":"V30-with-native-recipe-v54","proof_class":"visible_development",
