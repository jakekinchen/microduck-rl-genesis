...
FREEZE=ROOT/"experiments/walking/native-retention-surfaces-freeze-v50.json"
...
def main():
    ...
    try:
        ...
        result={"schema":"microduck.terrain-endurance-result/v1","bank":a.bank,"controller_variant":"V30-with-native-retention-v50","candidate":a.candidate,"proof_class":"visible_development",
