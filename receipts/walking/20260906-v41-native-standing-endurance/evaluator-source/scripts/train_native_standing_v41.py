...
FREEZE=ROOT/'experiments/walking/native-standing-freeze-v41.json'
...
def binding():
    ...
    extra=['scripts/train_native_standing_v41.py','microduck/native_standing_env_v41.py','experiments/walking/NATIVE-STANDING-v41.md',
        'experiments/walking/native_candidate_v41.py',
        'scripts/evaluate_native_standing_endurance_v41.py','scripts/evaluate_native_standing_flat_v41.py','scripts/evaluate_native_standing_surfaces_v41.py']
    ...
    return dict(schema='microduck.native-standing-freeze/v41',parent_sha256=PARENT_SHA,
...
def main():
    ...
    record=dict(schema='microduck.walking-training/v1',variant='native-standing-v41',proof_class='first_party_development',
    ...
    try:
        ...
        from microduck.native_standing_env_v41 import NativeStandingEnv
