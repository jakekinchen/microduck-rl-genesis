"""V41 native standing FINAL with V30 controller on exposed endurance gates."""
import argparse
import gzip
...
FREEZE=ROOT/"experiments/walking/native-standing-endurance-freeze-v41.json"
...
SOURCES = list(dict.fromkeys(SOURCES + ["scripts/evaluate_native_standing_endurance_v41.py", "scripts/train_native_standing_v41.py", "microduck/native_standing_env_v41.py", "experiments/walking/NATIVE-STANDING-v41.md", "experiments/walking/native_candidate_v41.py"]))
...
def main():
    ...
    stand,sp,stand_export=export_walking("standing-native-20260906-v41",a.output/"standing")
    ...
    try:
        ...
        result={"schema":"microduck.terrain-endurance-result/v1","bank":a.bank,"controller_variant":"V30-with-native-standing-v41","proof_class":"visible_development",
