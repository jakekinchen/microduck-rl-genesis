...
class ActivityTests(unittest.TestCase):
    def test_sequence_compute_is_detected(self):
        for entrypoint in ["probe_native_sequence_v44.py", "evaluate_native_sequence_flat_v44.py",
                           ...
                           "probe_handoff_inspection_v47.py", "verify_handoff_inspection_v47.py", "probe_recovery_v49.py", "probe_recovery_v51.py", "evaluate_braking_flat_v52.py", "evaluate_braking_endurance_v52.py", "evaluate_braking_surfaces_v52.py", "probe_native_sequence_v50.py",
