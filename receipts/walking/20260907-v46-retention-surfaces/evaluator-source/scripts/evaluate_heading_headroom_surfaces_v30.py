"""V30 heading controller with original actors on the exposed V25 surface bank."""
import argparse
...
FREEZE=ROOT/"experiments/walking/heading-headroom-surfaces-freeze-v30.json"
...
def main():
    ...
    try:
                            ...
                            try:
                                for i in range(round(window["duration_s"]*50)):
                                    ...
                                    if writer and i%2==0:
                                        ...
                                        draw.text((8,8),f'V30 | {name} | {row["session_time_s"]:.2f}s | {role}',fill="white")
        ...
        result={"schema":"microduck.terrain-endurance-result/v1","bank":a.bank,"candidate":a.candidate,"proof_class":"visible_development",
