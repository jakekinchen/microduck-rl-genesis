...
out=ROOT/'experiments/walking/retention-replay-v46'
if __name__=='__main__':
    ...
    for name in ['20260906-v30-flat-regression','20260906-v30-repeated-regression-r2']:
        ...
        if report['passed_cases']!=report['total_cases']:raise ValueError('passing original bank required')
        ...
        with opener(path,'rt') as f:
            for line in f:
                ...
                if row['actor_mode']!='walking':continue
