...
- [ ] Freeze one bounded native full-sequence learning experiment covering
  walk–brake–stand–restart and repeated turns. Begin with the retained V30 pair;
  retain actual observation/history coverage and a separately frozen fresh
  sequence bank. Preserve all 63 flat, both long compositions and physical-
  quality gates; improve downhill stopping and avoid exposed surface regression
  before new terrain expansion. This is the recommended next activity, not run.
