"""V28 motion-established heading on the exposed V24 endurance/terrain bank."""
import argparse
...
FREEZE=ROOT/"experiments/walking/motion-heading-endurance-freeze-v28.json"
                            ...
                            try:
                                for i in range(round(window["duration_s"]*50)):
                                    ...
                                    if writer and i%2==0:
                                        ...
                                        draw.text((8,8),f'V28 | {name} | {row["session_time_s"]:.2f}s | {role}',fill="white")
