"""V38 translational STOP deceleration on the exposed endurance bank."""
import argparse
import gzip
...
FREEZE=ROOT/"experiments/walking/stopping-endurance-freeze-v38.json"
...
SOURCES = list(dict.fromkeys(SOURCES + ["scripts/evaluate_stopping_endurance_v38.py", "microduck/stopping_ramp_v38.py", "experiments/walking/STOPPING-RAMP-v38.md", "tests/test_stopping_ramp_v38.py"]))
...
def main():
    ...
    try:
        ...
        result={"schema":"microduck.terrain-endurance-result/v1","bank":a.bank,"controller_variant":"stopping-ramp-v38","proof_class":"visible_development",
