"""V44 joint walking and standing FINAL with V30 controller on exposed surfaces gates."""
import argparse
import gzip
...
FREEZE=ROOT/"experiments/walking/native-retention-surfaces-freeze-v46.json"
...
from scripts.train_native_retention_v46 import EXTRA
...
def main():
    ...
    from experiments.walking.native_candidate_v46 import candidate_sha, WALK_RUN, STAND_RUN
    ...
    try:
                            ...
                            try:
                                for i in range(round(window["duration_s"]*50)):
                                    ...
                                    if writer and i%2==0:
                                        ...
                                        draw.text((8,8),f'V46 | {name} | {row["session_time_s"]:.2f}s | {role}',fill="white")
        ...
        result={"schema":"microduck.terrain-endurance-result/v1","bank":a.bank,"controller_variant":"V30-with-native-retention-v46","candidate":a.candidate,"proof_class":"visible_development",
