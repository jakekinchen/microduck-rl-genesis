...
SOURCES=["scripts/evaluate_walking_tracking.py","scripts/evaluate_walking.py","experiments/walking/posture.py","microduck/constants.py","scripts/export_walking.py","experiments/walking/world.py",
...
def main():
    ...
    a=p.parse_args()
    frozen=ROOT/"experiments/walking/evaluator-freeze-tracking-v1.json"
    if a.freeze:
    ...
    result={"schema":"microduck.walking-evaluation/v1","acceptance_variant":"motor-plus-neutral-head-v1","proof_class":"visible_development","held_out":False,
            ...
            "boundary":"Command/timing plus neutral-head visible development, no physical calibration. Raw ONNX action is unchanged; declared FIFO latency is a physical-loop parameter, not action smoothing."}
