"""V24 persistent heading on the exposed V21 flat regression; unchanged gates."""
import argparse
import json
...
FREEZE = ROOT/"experiments/walking/heading-regression-freeze-v24.json"
    ...
    if a.freeze:
        with FREEZE.open("x") as f:
            json.dump({"schema": "microduck.walking-evaluator-freeze/v1", "held_out": False,
                       "candidate": "V21 FINAL walker, V15 FINAL stander, V16 ramp and fixed V24 heading; exposed regression",
        ...
        for timing in suite["timing_profiles"]:
            for case in suite["cases"]:
                ...
                try:
                            ...
                            try:
                                for i in range(round(suite["duration_s"]*50)):
                                    ...
                                    if writer and i%2 == 0:
                                        ...
                                        draw.text((10,8), f"V24 {role.upper()} | {name} | {row['session_time_s']:.2f}s", fill="white")
                    ...
                    world.close()
    result = {"schema": "microduck.walking-evaluation/v1", "acceptance_variant": "heading-persistence-v24-flat-regression",
              ...
              "controller": "Fixed V16 command slew and V24 persistent-reference filtered IMU feedback; V21 FINAL walking / V15 FINAL standing; exact-zero ramped-command routing",
