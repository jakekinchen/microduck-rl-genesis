...
- [ ] Measure handoff-state and delay-history coverage under the candidate's
  own initial standing and repeated windows. V41/V42 trained on V30-generated
  starts with three-second isolated episodes. Freeze the next bounded change
  only after diagnosing the first failed handoff; retain 63 flat gates, both
  complete long compositions and slope/soft-contact acceptance requirements.
