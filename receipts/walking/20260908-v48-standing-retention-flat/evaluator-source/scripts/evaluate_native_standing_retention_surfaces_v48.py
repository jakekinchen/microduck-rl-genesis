"""V48 standing FINAL with original V21 walker with V30 controller on exposed surfaces gates."""
import argparse
import gzip
...
FREEZE=ROOT/"experiments/walking/native-standing-retention-surfaces-freeze-v48.json"
...
from scripts.train_native_standing_retention_v48 import EXTRA
...
def main():
    ...
    from experiments.walking.native_candidate_v48 import candidate_sha, WALK_RUN, STAND_RUN
    ...
    try:
                            ...
                            try:
                                for i in range(round(window["duration_s"]*50)):
                                    ...
                                    if writer and i%2==0:
                                        ...
                                        draw.text((8,8),f'V48 | {name} | {row["session_time_s"]:.2f}s | {role}',fill="white")
        ...
        result={"schema":"microduck.terrain-endurance-result/v1","bank":a.bank,"controller_variant":"V30-with-native-standing-retention-v48","candidate":a.candidate,"proof_class":"visible_development",
