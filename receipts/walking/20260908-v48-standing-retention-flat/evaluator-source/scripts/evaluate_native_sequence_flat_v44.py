"""V44 native standing FINAL with V30 controller on exposed flat gates."""
import argparse
import gzip
import json
...
FREEZE=ROOT/"experiments/walking/native-sequence-flat-freeze-v44.json"
...
def main():
    ...
    result = {"schema": "microduck.walking-evaluation/v1", "acceptance_variant": "native-sequence-v44-flat-regression",
              ...
              "controller": "Fixed V16 command slew and V30 float32 correction-headroom persistent-reference filtered IMU feedback; V21 FINAL walking / native V44 FINAL standing; exact-zero ramped-command routing",
