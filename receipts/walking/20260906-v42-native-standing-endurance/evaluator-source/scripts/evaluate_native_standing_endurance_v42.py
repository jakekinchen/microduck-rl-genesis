"""V42 native standing FINAL with V30 controller on exposed endurance gates."""
import argparse
import gzip
...
FREEZE=ROOT/"experiments/walking/native-standing-endurance-freeze-v42.json"
...
SOURCES = list(dict.fromkeys(SOURCES + ["scripts/evaluate_native_standing_endurance_v42.py", "scripts/train_native_standing_v42.py", "microduck/native_standing_env_v42.py", "experiments/walking/NATIVE-STANDING-v42.md", "experiments/walking/native_candidate_v42.py"]))
...
def main():
    ...
    stand,sp,stand_export=export_walking("standing-native-20260906-v42",a.output/"standing")
    ...
    try:
        ...
        result={"schema":"microduck.terrain-endurance-result/v1","bank":a.bank,"controller_variant":"V30-with-native-standing-v42","proof_class":"visible_development",
