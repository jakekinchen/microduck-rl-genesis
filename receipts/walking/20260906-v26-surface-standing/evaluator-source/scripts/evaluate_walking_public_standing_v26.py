...
FREEZE=ROOT/"experiments/walking/public-standing-freeze-v26.json"
from scripts.evaluate_walking_public_surfaces import SOURCES as V25_SOURCES
SOURCES=list(dict.fromkeys(V25_SOURCES+[
 "scripts/evaluate_walking_public_standing_v26.py", "experiments/walking/STANDING-SURFACE-ISOLATION-v26.md"
]))
...
def main():
    ...
    p.add_argument("--candidate",choices=("standing",),default="standing")
    a=p.parse_args()
    ...
    standing_run="standing-20260906-v25"
