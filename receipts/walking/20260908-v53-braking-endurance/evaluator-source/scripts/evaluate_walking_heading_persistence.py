"""Preregistered V24 native terrain/endurance with exact V21/V15 components."""
import argparse
...
FREEZE=ROOT/"experiments/walking/heading-persistence-freeze-v24.json"
                            ...
                            try:
                                for i in range(round(window["duration_s"]*50)):
                                    ...
                                    if writer and i%2==0:
                                        ...
                                        draw.text((8,8),f'V24 | {name} | {row["session_time_s"]:.2f}s | {role}',fill="white")
