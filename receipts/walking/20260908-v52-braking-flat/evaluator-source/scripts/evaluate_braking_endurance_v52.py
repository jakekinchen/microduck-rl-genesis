"""V50 walking FINAL and original V15 standing on unchanged endurance gates."""
import argparse
import gzip
...
FREEZE=ROOT/"experiments/walking/braking-endurance-freeze-v52.json"
...
def main():
    ...
    try:
        ...
        result={"schema":"microduck.terrain-endurance-result/v1","bank":a.bank,"controller_variant":"V52-transient-braking-on-V50-V15","proof_class":"visible_development",
