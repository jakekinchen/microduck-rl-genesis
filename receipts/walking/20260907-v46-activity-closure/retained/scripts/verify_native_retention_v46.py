...
def main():
    ...
    from scripts.train_native_retention_v46 import binding,FREEZE,PARENTS
    from experiments.walking.native_candidate_v46 import candidate_sha,RUN
    assert binding()==json.loads(FREEZE.read_text())
    walk_sha,stand_sha=candidate_sha()
    frozen_counts={}
    for path in sorted((ROOT/'experiments/walking').glob('native-retention*freeze-v46.json')):
    ...
    switches=np.zeros((12,2),int);switch_rows=0
    ...
    receipts={}
    for name in ['20260907-v46-retention-conformance','20260907-v46-retention-flat',
                 '20260907-v46-retention-repeated','20260907-v46-retention-endurance','20260907-v46-retention-surfaces',
                 '20260907-v45-analysis','20260907-v46-replay-parity']:
    ...
    shutil.copy2(Path(__file__),a.output/'verify_native_retention_v46.py')
