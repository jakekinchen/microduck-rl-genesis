...
FREEZE=ROOT/"experiments/walking/native-sequence-surfaces-freeze-v44-r2.json"
...
from scripts.train_native_sequence_v44 import EXTRA
...
def main():
    ...
    standing_run="sequence-native-20260907-v44-standing"
    ...
    try:
                            ...
                            try:
                                for i in range(round(window["duration_s"]*50)):
                                    ...
                                    if writer and i%2==0:
                                        ...
                                        draw.text((8,8),f'V44 | {name} | {row["session_time_s"]:.2f}s | {role}',fill="white")
        ...
        result={"schema":"microduck.terrain-endurance-result/v1","bank":a.bank,"controller_variant":"V30-with-native-sequence-v44","candidate":a.candidate,"proof_class":"visible_development",
