"""V42 native standing FINAL with V30 controller on exposed surfaces gates."""
import argparse
import gzip
...
FREEZE=ROOT/"experiments/walking/native-standing-surfaces-freeze-v42.json"
...
SOURCES = list(dict.fromkeys(SOURCES + ["scripts/evaluate_native_standing_surfaces_v42.py", "scripts/train_native_standing_v42.py", "microduck/native_standing_env_v42.py", "experiments/walking/NATIVE-STANDING-v42.md", "experiments/walking/native_candidate_v42.py"]))
...
def main():
    ...
    p.add_argument("--candidate",choices=("native-standing",),default="native-standing")
    a=p.parse_args()
    ...
    if a.freeze:
        with FREEZE.open("x") as f:
            json.dump({"schema":"microduck.terrain-endurance-freeze/v1",
                       ...
                       "walking_checkpoint_sha256":WALK_SHA,"standing_parent_checkpoint_sha256":STAND_SHA,
    ...
    from experiments.walking.native_candidate_v42 import candidate_sha
    stand_sha=candidate_sha()
    ...
    walking_run="walking-20260906-v21"
    standing_run="standing-native-20260906-v42"
    ...
    try:
                            ...
                            try:
                                for i in range(round(window["duration_s"]*50)):
                                    ...
                                    if writer and i%2==0:
                                        ...
                                        draw.text((8,8),f'V42 | {name} | {row["session_time_s"]:.2f}s | {role}',fill="white")
        ...
        result={"schema":"microduck.terrain-endurance-result/v1","bank":a.bank,"controller_variant":"V30-with-native-standing-v42","candidate":a.candidate,"proof_class":"visible_development",
