"""V30 float32 correction-headroom heading on the exposed flat regression."""
import argparse
import json
...
FREEZE = ROOT/"experiments/walking/heading-headroom-flat-freeze-v30.json"
    ...
    if a.freeze:
        with FREEZE.open("x") as f:
            json.dump({"schema": "microduck.walking-evaluator-freeze/v1", "held_out": False,
                       "candidate": "V21 FINAL walker, V15 FINAL stander, V16 ramp and fixed V30 heading; exposed regression",
        ...
        for timing in suite["timing_profiles"]:
            for case in suite["cases"]:
                ...
                try:
                            ...
                            try:
                                for i in range(round(suite["duration_s"]*50)):
                                    ...
                                    if writer and i%2 == 0:
                                        ...
                                        draw.text((10,8), f"V30 {role.upper()} | {name} | {row['session_time_s']:.2f}s", fill="white")
                    ...
                    world.close()
    result = {"schema": "microduck.walking-evaluation/v1", "acceptance_variant": "heading-headroom-v30-flat-regression",
              ...
              "controller": "Fixed V16 command slew and V30 float32 correction-headroom persistent-reference filtered IMU feedback; V21 FINAL walking / V15 FINAL standing; exact-zero ramped-command routing",
