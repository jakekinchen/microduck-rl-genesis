...
FREEZE=ROOT/"experiments/walking/native-retention-flat-freeze-v50.json"
        ...
        for timing in suite["timing_profiles"]:
            for case in suite["cases"]:
                ...
                try:
                    ...
                    world.close()
    result = {"schema": "microduck.walking-evaluation/v1", "acceptance_variant": "native-retention-v50-flat-regression",
