...
FREEZE=ROOT/"experiments/walking/native-sequence-fresh-freeze-v44.json"
...
SOURCES = list(dict.fromkeys(SOURCES + ["scripts/evaluate_native_sequence_fresh_v44.py", "scripts/train_native_sequence_v44.py", "microduck/native_sequence_env_v44.py", "experiments/walking/NATIVE-SEQUENCE-v44.md", "experiments/walking/native_candidate_v44.py"]))
...
def main():
    ...
    stand,sp,stand_export=export_walking("sequence-native-20260907-v44-standing",a.output/"standing")
    ...
    try:
        ...
        result={"schema":"microduck.terrain-endurance-result/v1","bank":a.bank,"controller_variant":"V30-with-native-sequence-v44","proof_class":"visible_development",
