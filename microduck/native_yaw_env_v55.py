"""V55: identical V54 dynamics/curriculum, parameterized downhill yaw weight."""
...
class NativeSequenceEnv:
    ...
    def __init__(self, num_envs, seed, output, yaw_weight=3.):
        ...
        self.cfg = dict(task='Native-Yaw-Refinement-v55', backend='native-mujoco',
            ...
            timings=TIMINGS, standing_actor_frozen=False, flat_retention_label_actor_visible=False, yaw_cost=f"{yaw_weight} * abs(actual yaw rate - requested yaw rate) / .20 on downhill walking")
