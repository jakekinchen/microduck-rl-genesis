"""V54 shared native dynamics and outcome-gated transition curriculum."""
...
class NativeSequenceEnv:
    ...
    def __init__(self, num_envs, seed, output):
        ...
        self.cfg = dict(task='Native-Locomotion-Recipe-v54', backend='native-mujoco',
            ...
            timings=TIMINGS, standing_actor_frozen=False, flat_retention_label_actor_visible=False, yaw_cost="3 * abs(actual yaw rate - requested yaw rate) / .20 on downhill walking")
