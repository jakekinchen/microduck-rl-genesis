"""Source-backed numerical solver alignment for isolated replay diagnostics.

Matches native Euler/Newton limits and tolerance, uses Genesis MuJoCo
compatibility mode, and retains the explicit native constraint timing/floor.
No reward, controller, model mass/inertia, or action changes. Not trained.
"""
import torch
...
class MicroduckSolverAlignedWalkingEnv(MicroduckGroundAlignedWalkingEnv):
    def __init__(self,num_envs,**kwargs):
        ...
        self.cfg.update(task="Walking-Posture-NativeSolver-v7",walking_version="v7-native-solver",
