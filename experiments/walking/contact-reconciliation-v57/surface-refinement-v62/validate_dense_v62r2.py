        ...
        try:
            ...
            with np.load(archive, allow_pickle=False) as arrays:
                for i in range(meta['parts']):
                    ...
                    if (i+1) % 100 == 0 or i+1 == meta['parts']:
                        print(json.dumps({'mesh': name, 'completed_parts': i+1, 'total_parts': meta['parts'], 'checked_samples': count, 'violations_so_far': violations}), flush=True)
