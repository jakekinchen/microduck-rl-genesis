...
import numpy as np
import trimesh
from cad_refinement_v62r4 import to_manifold, from_manifold, refine, excess_distances, face_samples
...
class GeometryTests(unittest.TestCase):
    ...
    def test_source_recess_is_preserved_and_partition_conserves_material(self):
        ...
        parts, records = refine(source, [box], self.config() | {'maximum_leaves_per_parent': 2})
