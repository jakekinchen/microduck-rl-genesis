...
**September 16 model prerequisite:** the new
[coverage audit](../../experiments/walking/upstream-audit-v56/README.md) confirms
that retained V11 checks 11 active colliders, while current upstream contains
70. A [separate copied-pose diagnostic](../../experiments/walking/contact-reconciliation-v57/README.md)
exposes jaw/neck hull interference that V11 cannot observe. Reconcile the
collision surfaces and frames, then perform passive and action-frozen dynamic
checks before expanding the physical support envelope. Original surface
scores remain unchanged and retain their original contact scope. Neither
these static checks nor online material priors calibrate Ducky on carpet.

The September 8 [feasibility review](CAPABILITY_FEASIBILITY_RESEARCH.md) compares
this strategy with current same-platform code and published physical locomotion
results. It supports staged expansion and recommends a bounded locomotion-recipe
comparison before another residual braking fit. No physical gate is closed by
that research.
