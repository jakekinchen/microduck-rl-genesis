...
| `TRAINING_ACTUALIZATION.md` | Authoritative ordered implementation queue and current evidence boundary. |
| `microduck_contract/` | Generated candidate interface, model, and BAM snapshots. |
| `environments/apple/` | Reproducible Apple dependency lane and acceptance commands. |
...
| Concern | Source |
|---|---|
| Product intent and build order | `TRAINING_ACTUALIZATION.md` |
| Architecture and invariants | `README.md`, `SIM2REAL.md`, and `microduck_contract/` |
